    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterDTO registerDTO)
        {
            ...
            if (result.Succeeded)
            {
                ...
                //Response.Cookies.Append("AuthToken", authenticationResponse.Token, new CookieOptions
                //{
                //    HttpOnly = true,
                //    Secure = true,
                ...
                //    HttpOnly = true,
                //    Secure = true,
                //    Expires = authenticationResponse.RefreshTokenExpirationDateTime
                //});

                //// Return AuthenticationResponse and redirect
                //TempData["PersonName"] = authenticationResponse.PersonName;
                //TempData["Email"] = authenticationResponse.Email;
                //TempData["Expiration"] = authenticationResponse.Expiration.ToString();
                #endregion
